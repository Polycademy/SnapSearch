		...
		<table cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
			<tr>
				<td valign="top" style="padding: 16px;"> 
					...
					<p>Please review your credit card details at your <a href="https://snapsearch.io/control_panel/payments">billing control panel</a>. You need to delete the card that met the error, and create a new active card. Once this is resolved, you must reinstate your previous API limit in the control panel. This month's charge will be added to the next month's charge.</p>

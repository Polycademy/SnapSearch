        ...
        <table cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
            <tr>
                <td valign="top" style="padding: 16px;"> 
                    ...
                    <p>Due to this error, we have started a grace period ending at <?= $grace_period_date ?>. This charge will be retried every <?= $grace_next_human_readable ?>. When this period finishes, your API limit will be downgraded to your API free limit.</p>

                    <p>Please review your credit card details at your <a href="https://snapsearch.io/control_panel/payments">billing control panel</a>. You must update your card that met the error, set up a new active card. Once this is resolved, you must reinstate your previous API limit in the control panel. If this month's charge is not resolved by the end of the grace period or the end of the charge interval (whichever is more recent), then this month's charge will be added to next month's charge.</p>

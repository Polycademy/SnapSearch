...
//we need to fix this up from PolyAuth, PolyAuth needs to return data for you send as email.
//IN FACT, PolyAuth shouldn't even bother with sending emails at all. That's a stupid anything!
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>SnapSearch Forgotten Password Reset</title>
		<style type="text/css">
		...
		<table cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
			<tr>
				<td valign="top" style="padding: 16px;"> 
					...
					<p>You have requested us to help reset your password. Head to this <a href="https://snapsearch.io/confirm_forgotten_password?user_id={{user_id}}&forgotten_code={{forgotten_code}}">link</a> to reset your password.</p>
...
$config['polyauth'] = array(
	...
	'email_port'			=> '587',
	'email_auth'			=> true,
	'email_username'		=> $_ENV['secrets']['sparkpost_api_user'],
	'email_password'		=> $_ENV['secrets']['sparkpost_api_pass'],

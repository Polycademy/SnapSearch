...
Pigeon::map(function($r){
	...
	$r->route('cli', false , function($r){
		...
		//Lockfiles purging
		//php index.php cli cron purge_lockfiles 45
		$r->route('cron/purge_lockfiles', 'cron#purge_lockfiles');
		$r->route('cron/purge_lockfiles/(.*)', 'cron#purge_lockfiles');
		...
		//Weekly session purge
		$r->route('cron/purge_sessions', 'cron#purge_sessions');
